...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PennyBaseCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"default", "199.188.204.205"}, //First official node
    {NULL, NULL},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PennyBaseCoin is probably already running."), addrBind.ToString().c_str());
        else
