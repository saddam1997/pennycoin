...
"Copyright &copy; 2011-YYYY The PennyBaseCoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About PennyBaseCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>PennyBaseCoin</b> version", 0));
